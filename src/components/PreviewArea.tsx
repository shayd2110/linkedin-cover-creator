...
export const PreviewArea: React.FC<PreviewAreaProps> = ({ coverRef, showMockup, setShowMockup }) => {
  ...
  useEffect(() => {
    const handleResize = () => {
      if (previewContainerRef.current) {
        const contentWidth = previewContainerRef.current.clientWidth;
        // The cover native width is 1584px
        const scale = contentWidth / 1584;
  ...
  return (
    <section className="preview-area">
      ...
      <div className="preview-container" style={{ paddingBottom: showMockup ? "100px" : "20px" }}>
        <div

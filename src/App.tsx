            ...
            {activeTab === "background" && (
              <div className="tab-pane">
                ...
                <div className="bg-source-selector">
                  <button className={bgSource === "unsplash" ? "active" : ""} onClick={() => setBgSource("unsplash")}>
                    Unsplash Search
                  </button>
                  <button className={bgSource === "upload" ? "active" : ""} onClick={() => setBgSource("upload")}>
                    File Upload
                  </button>
                  <button className={bgSource === "url" ? "active" : ""} onClick={() => setBgSource("url")}>
                    Image URL
                  </button>
                </div>
